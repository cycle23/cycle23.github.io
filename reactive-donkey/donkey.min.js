...
$jscomp.inherits=function(a,b){function c(){}c.prototype=b.prototype;a.superClass_=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.base=function(a,c,e){var g=Array.prototype.slice.call(arguments,2);return b.prototype[c].apply(a,g)}};var canvas=document.getElementById("canvas");(new Audio("../../media/music/coldwet.mp3")).play();function extend(a,b){for(var c in b)a[c]=b[c]}function assoc(){for(var a={},b=0;b<arguments.length;b++)extend(a,arguments[b]);return a}
function coordBI(a,b){return a+(b||0)|0}function onscreen(a){return!(-300>a.x||-1E3>a.y||1E3<a.y)}function velocity(a){return assoc(a,{x:a.x+a.vx,y:a.y+a.vy})}function intersects(a,b){var c=coordBI(b.x,b.baseX),d=coordBI(a.x,a.baseX),f=coordBI(b.y,b.baseY),e=coordBI(a.y,a.baseY);return 100>Math.abs(d-c)&&100>Math.abs(e-f)}function makeElement(a){return React.DOM.div({className:a.id,style:{left:a.x+(a.baseX||0)|NaN,top:a.y+(a.baseY||0)|NaN}},a.text)}
