...
(a.gameOver=!0,a.id="pinkie gameover",a.points=0,a.vy=-20,(new Audio("../../media/sound/gameover.mp3")).play());if(a.gameOver)return a.vy+=.5,a.points+=1,a;a.vy+=.98;0<=a.y&&0<a.vy&&(a.id="pinkie",a.y=0,a.vy=0);"space"===c[0]&&0===a.y&&(a.id="pinkie jumping",a.vy=-20,(new Audio("../../media/sound/jump.mp3")).play());return a}).takeWhile(onscreen),initialCoin={id:"coin",vx:-6,vy:0,x:1600,y:40},coinStream=pinkieStream.scan(initialCoin,function(a,b){a=velocity(a);0>a.vy&&(a.vy*=2);0===a.vy&&intersects(a,
b)&&((new Audio("../../media/sound/coin.mp3")).play(),a.vx=0,a.vy=-1);return onscreen(a)?a:initialCoin}),initialStat={id:"stat",x:0,y:0,points:0,text:"Init.."},statStream=coinStream.scan(initialStat,function(a,b){-1===b.vy&&(a.points+=1);a.text="Points: "+a.points;return a});(new Audio("../../media/music/coldwet.mp3")).play();Rx.Observable.zipArray(groundStream,pinkieStream,coinStream,statStream,haterStream).subscribe(renderScene);
