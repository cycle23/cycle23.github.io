...
c,d,f){var g="string"===typeof a?a:a.mp3.split(".")[0].asId(),g=b.mbAudio.queue.get(g);null===g&&(g=new k(a));var e="string"===typeof a?b.mbAudio.sounds[a]:a;e.started||(b.mbAudio.pause(a),e.started=!0);c="string"===typeof c?e.sprite[c]:c;e={};e.soundID=a;e.sprite=c;e.channel=g;e.hasPriority=f;e.callback=d;b.mbAudio.queue.isStarted||b.mbAudio.queue.startEngine();b.mbAudio.soundsMutedByHand||(e.hasPriority?(e.channel.playingSounds.splice(0,1),e.channel.soundInPlay=null,g.playingSounds.unshift(e)):
g.playingSounds.push(e))},get:function(a){for(var c in b.mbAudio.ch)if(b.mbAudio.ch[c].name===a)return b.mbAudio.ch[c]},manage:function(){function a(a){null===a.soundInPlay&&a.playingSounds&&0<a.playingSounds.length&&!b.mbAudio.soundsMutedByHand&&!a.isMuted?(a.soundInPlay=a.playingSounds[0],b.mbAudio.play(a.soundInPlay.soundID,a.soundInPlay.sprite,function(){"function"===typeof a.soundInPlay.callback&&a.soundInPlay.callback();a.playingSounds.splice(0,1);a.soundInPlay=null})):null!==a.soundInPlay&&
a.soundInPlay.soundID&&(b.mbAudio.soundsMutedByHand||a.isMuted)&&(b.mbAudio.pause(a.soundInPlay.soundID),a.playingSounds=[],a.playingSounds.unshift(a.soundInPlay),a.soundInPlay=null)}for(var c in b.mbAudio.ch)a(b.mbAudio.ch[c])},mute:function(a){if(a){var c=b.mbAudio.queue.get(a);c&&(c.isMuted=!0);b.mbAudio.pause(a)}else b.mbAudio.soundsMutedByHand=!0},unMute:function(a){if(a){if(a=b.mbAudio.queue.get(a))a.isMuted=!1}else b.mbAudio.soundsMutedByHand=!1},clear:function(a){if(a=b.mbAudio.queue.get(a))null!==
a.soundInPlay&&b.mbAudio.pause(a.soundInPlay.soundID),a.soundInPlay=null,a.playingSounds=[]},startEngine:function(){b.mbAudio.channelsEngine=setInterval(b.mbAudio.queue.manage,1);b.mbAudio.queue.isStarted=!0},stopEngine:function(){clearInterval(b.mbAudio.channelsEngine);b.mbAudio.queue.isStarted=!1}}}})(jQuery);
